...
predicted_targets = predicted_temp
...
plt.figure()
plt.title('Real and predicted temperature using GRU RNN')
...
# np.savetxt('./parameters-gru/test_samples.csv', test_samples, delimiter=',')
# np.savetxt('./parameters-gru/test_targets.csv', test_targets, delimiter=',')
# np.savetxt('./parameters-gru/predicted_targets.csv', predicted_targets, delimiter=',')
